...
export default function App() {
  ...
  return (
    <div className="outer">
      <section
        ref={s1.ref}
        className={`section_W ${s1.inView ? "is-in" : ""}`}
        id="frame1"
      >
        <div className="all_box">
          ...
          <div className="button_container fade-up-stagger">
            <div
              className="btn"
              onClick={() =>
                window.open("https://velog.io/@pooh00316", "_blank")
              }
            >
              <img src={velIcon} alt="Velog로 이동" />
            </div>

            <div
              className="btn"
              onClick={() =>
                window.open("https://github.com/uowllnh", "_blank")
              }
            >
              <img src={gitIcon} alt="github로 이동" />
            </div>
          </div>
        </div>

        <div
          className={"arrow fade-up-stagger"}
          onClick={() => scrollToNextSection("frame1")}
        >
          <img src={arrow} alt="아래로 이동" width={40} height={40} />
        </div>
      </section>
      ...
      <section className="section_G" id="frame2">
        ...
        <div className="arrow" onClick={() => scrollToNextSection("frame2")}>
          <img src={arrow} alt="아래로 이동" width={40} height={40} />
        </div>
      </section>
      ...
      <section className="section_G" id="frame3">
        ...
        <section className="projects-overlay">
          <div className="projects-layout">
            <div className="project-seed-controls">
            ...
            <div className="txt_button_container">
              <button
                type="button"
                className={`text-btn ${
                  selected === "personal" ? "is-active" : "is-inactive"
                }`}
              ...
              <button
                type="button"
                className={`text-btn ${
                  selected === "team" ? "is-active" : "is-inactive"
                }`}
        ...
        <div className="arrow" onClick={() => scrollToNextSection("frame3")}>
          <img src={arrow} alt="아래로 이동" width={40} height={40} />
        </div>
      </section>
      ...
      <section
        ref={s4.ref}
        className={`section_W ${s4.inView ? "is-in" : ""}`}
        id="frame4"
      >
        <div className="all_box">
          <Lottie animationData={ThanksAnim} />
          <div className="button_container" style={{ top: "70%" }}>
            <div
              className="btn"
              onClick={() =>
                window.open("https://velog.io/@pooh00316", "_blank")
        ...
        <div className="arrow" onClick={() => scrollToNextSection("frame4")}>
          <img
            src={arrow}
            alt="아래로 이동"
            width={40}
