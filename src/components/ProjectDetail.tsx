...
export default function detail_page({
  ...
  retrospective,
    ...
    const images = [image1, image2].filter((src): src is string => Boolean(src));
        ...
        <section className=" flex justify-center items-center z-10">
             <div className="w-[1150px] flex flex-col items-center text-white mt-[100px]">
                    ...
                    <section className="상단 flex flex-col items-center gap-[100px] mt-[96px] mb-[162px]">
                        ...
                        <p className="text-[20px] mt-[37px] whitespace-pre-line">{role}</p>
                        </div>
                        )}
                    ...
                    <section className="하단 mt-[162px] flex flex-col items-center gap-[110px]">
                        ...
                        <DetailSection title="프로젝트 개요">
                          <p className="text-[18px] text-[#E6E6E6] leading-[2.5rem]"> {detail} </p>
                        </DetailSection>
                          ...
                          <DetailSection title="트러블슈팅">
                            <div className="flex flex-col gap-[24px]">
                              {troubleshooting.map((item) => (
                                <article key={item.issue} className="border border-white/15 bg-white/5 p-[28px]">
                            ...
                            <div className="grid grid-cols-2 gap-[28px]">
                              {screenshots.map((image) => (
                                <figure key={image.src} className="flex flex-col gap-[12px]">
                                  ...
                                  {image.caption && (
                                    <figcaption className="text-[15px] text-[#B5B5B5]">{image.caption}</figcaption>
                                  )}
                                </figure>
                              ))}
                            </div>
