...
export const yupddukData: ProjectProps = {
      ...
      member: "개인 프로젝트",
      detail: "기존 엽기떡볶이 앱은 메뉴 탐색 구조가 복잡하고 주문 과정에서 선택 상태를 확인하기 어려운 문제가 있었습니다. 특히 메뉴 리스트, 옵션 선택, 주문 확인 화면에서 정보 위계가 명확하지 않아 사용자가 주문 흐름을 따라가기 어려웠습니다. 이를 개선하기 위해 메인 화면, 메뉴 리스트, 주문 화면 UX를 중심으로 리디자인을 진행했습니다.",
      period: "2025.03",
      ...
      improvements: [
        {
          title: "메인 화면 구조 개선",
          before: "이벤트 배너와 메뉴 정보가 한 화면에 혼합되어 정보 우선순위가 불명확했습니다.",
          after: "대표 메뉴, 이벤트, 주문 진입 영역을 분리해 화면 구조를 정리했습니다.",
          result: "사용자가 주요 기능과 메뉴를 더 빠르게 인지할 수 있도록 개선했습니다.",
          image: {
            src: img1,
            alt: "엽기떡볶이 메인 화면 개선",
            caption: "메인 화면 개선",
        ...
        },
        {
          ...
          after: "옵션 영역과 가격 정보를 가까운 위치에 배치하고 선택 상태를 강조했습니다.",
          result: "주문 전 사용자가 선택 내용을 쉽게 확인할 수 있도록 개선했습니다.",
          image: {
            src: img2,
            alt: "엽기떡볶이 주문 구조 개선",
            caption: "주문 화면 개선",
      ...
      troubleshooting: [
        {
          ...
          solution: "이미지, 메뉴명, 가격, 설명의 우선순위를 정리해 카드형 UI로 재구성했습니다.",
