...
export const yoringData: ProjectProps = {
  ...
  member: "FE 1명\nBE 2명",
  detail:
    "통신사별 요금제는 종류가 많고 혜택 구조도 달라 사용자가 자신에게 맞는 요금제를 직접 비교하기 어렵습니다. 기존 통신사 앱은 자사 요금제 중심으로만 탐색이 가능해 여러 통신사의 요금제를 한눈에 비교하기 어렵다는 한계가 있었습니다. Yoring은 사용자의 데이터 소비 패턴, 연령대, 사용 목적 등을 기반으로 적합한 요금제를 추천해주는 모바일 앱입니다.",
  period: "2023.11 ~ 2024.11",
  stack: ["Java", "AndroidStudio", "FireBase", "Figma", "GitHub"],
  githubUrl: "https://github.com/uowllnh/Yoring",
  myRoles: [
  ...
  improvements: [
    {
      title: "메인 화면 구조 개선",
      before:
        "기능이 분산되어 있어 사용자가 핵심 기능을 빠르게 찾기 어려웠습니다.",
