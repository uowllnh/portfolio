...
export const metaPlannerData: ProjectProps = {
      ...
      member: "개인 프로젝트",
      detail: "Meta Planner는 사용자의 목표 관리와 집중 루틴 형성을 돕기 위한 모바일 플래너 앱입니다. 기존 플래너 앱은 기능은 많지만 화면 정보량이 많아 사용자가 피로감을 느끼거나 핵심 기능에 집중하기 어려운 경우가 있었습니다. 이를 개선하기 위해 일정 관리, 집중 타이머, 루틴 확인 기능을 중심으로 직관적인 모바일 UI를 설계했습니다.",
      period: "2025.03 ~ ing",
      ...
      improvements: [
        {
          ...
          result: "사용자가 현재 집중 상태를 직관적으로 인지할 수 있도록 개선했습니다.",
          image: {
            src: img1,
        ...
        {
          title: "플래너 화면 구조 개선",
          before: "일정과 루틴 정보가 분산되어 하루 계획을 한눈에 파악하기 어려웠습니다.",
          after: "중요 일정, 목표, 루틴 정보를 우선순위에 따라 재배치했습니다.",
          result: "사용자가 하루 계획을 빠르게 확인하고 실행할 수 있도록 개선했습니다.",
          image: {
            src: img2,
      ...
      troubleshooting: [
        {
          ...
          result: "사용자가 집중 상태와 남은 시간을 빠르게 인지할 수 있도록 개선했습니다.",
        },
        {
      ...
      collaboration: [
        "개인 프로젝트로 기획, 디자인, 개발 흐름을 직접 설계",
        "Figma를 활용해 모바일 화면 구조를 먼저 설계",
